...
sendBtn.addEventListener("click", (e) => {
  ...
  let urlAndMethodForm = document.querySelector("#urlAndMethodForm");
  method = urlAndMethodForm.methods.value;
  url = urlAndMethodForm.apiSearch.value;
...
let saveApiBtn = document.querySelector("#saveApiBtn");
...
saveApiBtn.addEventListener("click", async () => {
  ...
  if (method || url) {
    fetchURL = await fetch("https://elegant-moth-zipper.cyclic.app/Api/saveUserApi", {
      ...
      body: JSON.stringify(ApiDataObj),
    });
